...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdClient).HasName("PK__Client__C1961B336F427087");
        ...
        {
            entity.HasKey(e => new { e.IdClient, e.IdTrip }).HasName("PK__Client_T__C823521EFF01C7B9");
            ...
            entity.HasOne(d => d.IdClientNavigation).WithMany(p => p.ClientTrips)
                ...
                .HasConstraintName("FK__Client_Tr__IdCli__2F2FFC0C");

            entity.HasOne(d => d.IdTripNavigation).WithMany(p => p.ClientTrips)
                .HasForeignKey(d => d.IdTrip)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Client_Tr__IdTri__30242045");
        });

        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.IdCountry).HasName("PK__Country__F99F104DF8914509");
            ...
            entity.HasMany(d => d.IdTrips).WithMany(p => p.IdCountries)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Trip>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__Country_T__IdTri__2C538F61"),
                    l => l.HasOne<Country>().WithMany()
                        .HasForeignKey("IdCountry")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__Country_T__IdCou__2B5F6B28"),
                    j =>
                    {
                        j.HasKey("IdCountry", "IdTrip").HasName("PK__Country___F02A59609EE22398");
        ...
        {
            entity.HasKey(e => e.IdTrip).HasName("PK__Trip__9B5492D1A03A51A6");
